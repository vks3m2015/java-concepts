...
class Base {
    ...
    //This is private method, not inherited to child class.
    // If child class create method with same name it will be considered as new method
    ...
    public static void staticInBaseButNonStaticInChild() {
...
class Derived extends Base {
	 ...
	 *
	 public void staticInBaseButNonStaticInChild(){
   	    System.out.println(" class - Base , method - staticInBase ....");
     }*/
	  ...
	  * 
	  public static void nonStaticInBaseButStaticInDerived(){
    	 System.out.println("  class - Base , method - nonStaticInBaseButStaticInDerived....");
     }
     */

    /*
     *  If we have different return type other than covariant( subtype ) it will not be overriding as below method
     *  (given method signature is same)
     */
    //ERROR - Incompatible return type
    /*public C sameMethodSignatureDiffReturnType(String str, int i) {
        System.out.println(" class Base, method sameMethodSignatureDiffReturnType...");
        return new C();
    }*/
